...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{This Gem provides offset based pagination for graphql-ruby}
  spec.description   = %q{This Gem provides offset based pagination for graphql-ruby}
